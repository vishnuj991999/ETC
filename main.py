...
with col1:
    st.markdown("<h2 style='text-align: left; font-family: Lora, serif;'>ETChat</h2>", unsafe_allow_html=True)  # Left-aligned title with Georgia font

with col2:
    st.image("ETC.png", width=150)  # Right-aligned logo (replace with actual image path)
